...
PCT=98
DATASET=gisette
echo  nohup taskset -c 29-58 python3 evaluate.py --dataset $DATASET --insert covariance --countsketch.repetitions 5 --countsketch.range 20000 --insert.samples_for_mu 500 --use_first_K_features 1000 --eval_alpha $ALPHA  --run_base "&" 
for pct in 95 98 99
do
for frac in 0.05
do
echo  nohup taskset -c 10-58 python3 evaluate.py --dataset $DATASET --insert covariance --countsketch.repetitions 5 --countsketch.range 20000 --insert.samples_for_mu 500 --use_first_K_features 1000 --alpha $ALPHA  --target_prob1 0.05 --target_prob2 0.15  --threshold_method infer2 --threshold.infer2.sig_pct $pct --threshold.infer2.init_pct 0  --threshold.infer2.inexp_frac $frac --eval_alpha $ALPHA "&"
done
done
