...
#(base) apd10@yogi:~/experiments/projects/CompressCovariance/topk$ python3 eval_pickle.py  --dataset X --pickle ./record/DSurl_K5_R5000000_TOP1000TH0.0e+00_THETA0.0e+00_EXP0_topK.pickle 
#2.0586846 2.827805 2.1916575
#(base) apd10@yogi:~/experiments/projects/CompressCovariance/topk$ python3 eval_pickle.py  --dataset X --pickle ./record/DSurl_K5_R1000000_TOP1000TH0.0e+00_THETA0.0e+00_EXP0_topK.pickle 
#3.247042 4.561938 3.4455805
#(base) apd10@yogi:~/experiments/projects/CompressCovariance/topk$ python3 eval_pickle.py  --dataset X --pickle ./record/DSurl_K5_R10000000_TOP1000TH0.0e+00_THETA0.0e+00_EXP0_topK.pickle 
